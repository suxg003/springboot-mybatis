...
function showINvestRecordsTable(type){
    ...
    $('#repayRecordsTable').dataTable({
        ...
        "sAjaxSource": "/fund/repay/records",
...
$('#downloadrepay').on('click',function (){

    var $dateRange=$('#date-range-picker').val();
    var type = $('.investBtnGroup .btn-sky').attr('data-id');
    var searchStr = $('#repayRecordsTable_filter input').val();
    var href = '/fund/repay/down?startDate=' + $dateRange.split(' - ')[0]+'&endDate='+$dateRange.split(' - ')[1]+'&type='+type+'&sSearch='+searchStr;
