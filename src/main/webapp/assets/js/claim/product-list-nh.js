...
Func.prototype.loadData = function () {
    ...
    $('#reProRecordsTable').dataTable({
        ...
        "bDestroy": true,
        "aoColumns": [
            {"mData": "productName", "sDefaultContent": ""},//0
        ...
        "aoColumnDefs": [
            {
                ...
                "mRender": function (data, type, row) {
                    return '<a class="blue" href="/claimInvest/newHandInvest?productId=' + row.productId + '">' + data+ '</a>';
                }
            },{
                "aTargets": [1],
                "mRender": function (data, type, row) {
            ...
            },
            {
                "aTargets": [10],
                "mRender": function (data, type, row) {
                    return '<div class="btn-group btn-group-justified" style="width: 80px;"><a class="btn btn-sm btn-blue" href="/claimInvest/newHandInvest?productId=' + row.productId + '">投资记录</a></div>';
                }
            }
        ],
        "sAjaxSource": "/claimProduct/list/newHand",
