              ...
              <div class="row">
                <div class="col-md-12 F-right">
                  <div class="buttons-preview">
                    <span class="F-left MargT-5  MargR-5">审批通过时间:</span>
...
<script src="/assets/js/claim/redeemed-list.js"></script>

<script>
  var pmRedeemed = new Func("MONTH_WIN","SUCCESSFUL","false");
  pmRedeemed.init();
</script>
