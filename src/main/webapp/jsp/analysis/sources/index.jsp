            ...
            <div class="page-body">
                <div class="well">
                    ...
                    <div class="table-toolbar">
                                ...
                                <div class="col-md-12 F-right">
                                    <div class="buttons-preview">
                                        ...
                                        <select name="source" id="source"
                                            ...
                                            <option value="MSTATION">m站浏览器</option>
                        ...
                        <table id="sourcesIndex" class="table table-hover dataTable no-footer">
...
<script src="/assets/js/analysis/sources/index.js"></script>

<script>
    var sourcesIndex = new Func();
    sourcesIndex.init();
</script>
