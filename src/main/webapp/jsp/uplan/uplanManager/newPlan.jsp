...
<div class="main-container container-fluid">
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <!-- Page Body -->
            <div class="page-body">
                <form class="form-horizontal new-plan-form" name="new-plan-form" id="newPlanForm" action="/uplan/publishUplan" method="POST">
                        <div class="widget-box transparent">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" id="userLoginName" class="form-control pull-left" name="userLoginName" placeholder="请输入注册用户账户名"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4" id="realUserName" name="realUserName"data-id="">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4" id="realUserIdNumber" name="realUserIdNumber">
                                </div>
                                <input type="hidden" id="userIdNumber" name="userIdNumber"/>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="errorText hide"><i class="icon-warning-sign"></i> 合同显示借款人和借款人必须同时输入</div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="wizard">
                                ...
                                <div class="form-group has-feedback margin-top-10">
                                   <label class="col-lg-3 control-label">产品介绍：</label>
                                    <div class="col-lg-4">
                                        <textarea name="productMemo" rows="3" cols="45"></textarea>
                            ...
                            <div class="wizard">
                                ...
                                <div class="creditInfoListWarp">
                                    ...
                                    <table class="table margin-top-30" id="creditInfoList">
                            ...
                            <div class="wizard">
                                ...
                                <div class="form-group has-feedback margin-top-10">
                                    ...
                                    <div class="controls col-lg-4">
                                        <div class="input-group">
                                            <input type="text" id="rate" name="floatRate" class="form-control" value="0" readonly="readonly"/>
                            ...
                            <div class="wizard">
                                ...
                                <div class="form-group margin-top-10">
                                    ...
                                    <div class="controls col-lg-4">
                                        <div class="input-group">
                                            <input type="text"id="rateAdd" name="floatRateAdd" class="form-control" value="0"/>
                                            <span class="input-group-addon">%</span>
                                        </div>

                                        <div class="errorText inline hide"><i class="icon-warning-sign"></i> 请输入正确的候补年利率</div>
                                    </div>
                                    <div class="inline-block grey col-lg-4">（年利率范围：0% ~ 24%）</div>
                                </div>
                                <div class="form-group margin-top-10">
                                    ...
                                    <div class="controls col-lg-4">
                                        ...
                                        <div class="errorText inline hide"><i class="icon-warning-sign"></i> 最小投资额错误</div>
                                    </div>
                                </div>
                                <div class="form-group margin-top-10">
                                    ...
                                    <div class="errorText inline hide"><i class="icon-warning-sign"></i> 投资增量错误</div>
                                </div>
                                <div class="form-group  margin-top-10">
                                ...
                                <div class="form-group  margin-top-10">
                                    <label class="control-label col-lg-3">推荐为新手标：</label>
                                    <div class="controls col-lg-4" id="isFresh">
                                        <label class="radio-inline">
                                          <input type="radio" value="0" style="position:relative;left:0;height:auto;opacity:1" name="fresh" checked="checked"> 否
                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" value="1" style="position:relative;left:0;height:auto;opacity:1" name="fresh"> 是
                                        </label>
                                        <input type="hidden" name="freshPlan">
                                    </div>
                                </div>
                                <div class="form-group">&nbsp;</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls col-lg-4">
                                <cm:securityTag privilegeString="UPLAN_NEWPLAN"> 
