      ...
      <div class="page-body">
        <div class="well">
	        <div class="row">
	        	...
	        	<div class="col-lg-12 col-sm-12 col-xs-12">
		        	<div class=" F-right" style="width:150px;">
			        	<div class="form-group pull-right">
	                        ...
	                        <span class="btn btn-small btn-danger downloadLink" id="downloadinvest" target="_blank" >下载</span>
			        	</div>
		          	</div>
				...
				<table id="investRecordsTable" class="table table-bordered">
		        	<thead>
		            	<tr>
		              		<th>投标人</th>
		              		<th>真实姓名</th>
...
<script src="/assets/js/fund/reconciliation/investRecords.js"></script>
</body>
</html>
