...
<body class="navbar-fixed">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="table-toolbar">
                                	<cm:securityTag privilegeString="CLAIM_CURRENT_ADD">
                                        ...
                                        <cm:securityTag privilegeString="CLAIM_CURRENT_IMPORT">
                                        <a id="downclaimlist" href="/claimLoan/currentLoanListExport" class="btn btn-default">
                            ...
                            <div class="table-toolbar">
                                <div id="investRecordHistory"
                                    ...
                                    <div class="control-group  pull-left">
                                        ...
                                        <div class="control-group pull-left">
                                            <cm:securityTag privilegeString="CLAIM_CURRENT_LIST">
                                    ...
                                    <div class="control-group  pull-right">
                                        ...
                                        <cm:securityTag privilegeString="CLAIM_CURRENT_BATCH_OPEN">
                                            <span>批量操作：</span>
    ...
    <script id="addClaimBox-template" type="text/x-handlebars-template">
        <form id="addClaimForm" class="form-horizontal" action="/claimLoan/saveOrUpdateCurrent" method="POST">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-4" for="flagBannedRadio"><em>*</em>债权启用:</label>
    ...
    <script src="/assets/js/claim/cur_list.js" type="text/javascript"></script>
    </body>
</html>