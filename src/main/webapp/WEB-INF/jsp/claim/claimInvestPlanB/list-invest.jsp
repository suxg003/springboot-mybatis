			...
			<div class="page-content">
				...
				<div class="page-breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active"><a href="/claimProduct/claimInvestPlanB/proList">定期计划B</a></li>
						    ...
						    <div class="widget-body">
								<div class="table-toolbar">
									<div id="investRecordHistory"
										...
										<!-- 
							          	<div class="form-horizontal pull-left" style="width:200px;">
						                	<div class="form-group pull-right">
						                    	<label class=" control-label no-padding-right pull-left" style="width:70px;margin-right:5px;">查询类型</label>
						                        <div class="pull-right" style="width:150px;">                                    
								                    <select name="payPath" class="">
								                        <option value="">请选择</option>
					                                    <option value="">投资人账户名</option>
					                                    <option value="">投资人姓名</option>			                                    
								                    </select>                                    
						                        </div>
						                    </div>
						               	 </div>
										...
										<table class="table table-striped table-hover dataTable no-footer" id="reProRecordsTable" aria-describedby="simpledatatable_info">
											...
											<tbody>
												...
												<tr>
													...
													<td>投资中</td>
													<td>
														<div class="btn-group btn-group-justified" style="width: 130px">
															<a class="btn btn-sm btn-palegreen" href="javascript:void(0);" style="font-size: 10px;"><i>债权查看</i></a>
															<a class="btn btn-sm btn-info" href="/" style="font-size: 10px;"><i>通知单</i></a>
														</div>
													</td>
												</tr>
												 -->
