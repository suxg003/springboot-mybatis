        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="/claimProduct/pmProList">月盈计划</a></li>
                    <li class="active"><a href="/claimProduct/pmProList">产品列表</a></li>
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12" style="margin-bottom:30px;">
                    ...
                    <div class="widget-body">
                        <div class="row detail-invest">
                            ...
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                                当期发布金额：<span class="red bold"><fmt:formatNumber type="number" pattern="#,###.##"
                                                                                 value="${product.amount}"/>元</span>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                                当期剩余金额：<span class="red bold"><fmt:formatNumber type="number" pattern="#,###.##"
                                                                                 value="${product.remainAmount}"/>元</span>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                            ...
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                                起投金额：<span class="red bold"><fmt:formatNumber type="number" pattern="#,###.##"
                                                                               value="${product.minAmount}"/>元</span>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                                最高限额：<span class="red bold"><fmt:formatNumber type="number" pattern="#,###.##"
                                                                               value="${product.maxAmount}"/>元</span>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                                投资增量：<span class="red bold"><fmt:formatNumber type="number" pattern="#,###.##"
                                                                               value="${product.increaseNum}"/>元</span>
                            </div>
                            <div class="col-lg-3 col-sm-3 col-xs-12 margin-bottom-10">
                        ...
                        <div class="row text-center margin-top-10">
                            <a href="/claimProduct/pmProList" class="btn btn-sm btn-blue">返回产品列表</a>
                        </div>
                    </div>
                </div>
