                ...
                <div class="well">
                    <div class="table-toolbar">
                        <a onclick="uploadStaffInfo()" data-target="#batchStaff" href="javascript:void(0);" class="btn btn-default">
                            <i class="fa fa-upload"></i> 批量维护
                        </a>
                    </div>
                    <table class="table table-hover" id="userMaintenanceListList" aria-describedby="simpledatatable_info">
                        <thead id="list_th">
                        <tr>
                            <%--<th class="hidden-480">用户id</th>--%>
                            <th class="hidden-480">用户身份证</th>
                            <%--<th class="hidden-480"> 员工编号</th>--%>
                            <th class="hidden-480">手机号</th>
                            <th class="hidden-480">用户名</th>
                            <%--<th class="hidden-480">推荐userid</th>--%>
                            <th class="hidden-480">推荐人身份证号</th>
                            <th class="hidden-480"> 推荐人员工编号</th>
                            <th class="hidden-480">维护人身份证号</th>
                                <th class="hidden-480">维护人员工编号</th>
                            <%--<th class="hidden-480">修改人</th>--%>
...
<script src="/assets/js/lendCustomer/maintenance-list.js"></script>
<script>
