  ...
  $(function () {
    ...
    var oTable = $('#commonDataTable').dataTable({
      ...
      "aoColumns": [
        {"mData": "loginName"}, //0
        {"mData": "userName"}, //1
        {"mData": "investAmount"}, //2
        {"mData": "bidMethodKey"}, //3
        {"mData": "submitTime"}, //4
        {"mData": "status"}, //5
        {"mData": "loanTitle"}, //6
        {"mData": "duration"}, //7
      ...
      "aoColumnDefs": [{
        ...
        "bSortable": false,
        "aTargets":[3], "mRender":function(data){
          return '手头投标'
        }
      },{
        "bSortable": false,
      ...
      "sAjaxSource": "/statistics/investRecords",
    ...
    $('#downloadHistoryBtn').click(function () {
      ...
      var href = '/statistics/downInvestRecords?startDate=' + $dateRangeP.split(' - ')[0]+'&endDate='+$dateRangeP.split(' - ')[1]+'&sSearch='+$('#commonDataTable_filter input').val();
      $(this).prop('href', href);
    });
  });
</script>
