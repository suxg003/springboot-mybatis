                ...
                <div class="well">
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="LOANS_LIST" aria-describedby="simpledatatable_info">
                        ...
                        <c:forEach var="emp" items="${employeeList}">
                            <tr>
                                <td>
                                    <a href="/employee/profile/${emp.empId}">${emp.name}</a>
                                </td>
                                <td>${emp.loginName}</td>
                                <td class="hidden-480">${emp.empId}</td>
                                <td class="hidden-480">${emp.mobile}</td>
                                        ...
                                        <c:choose>
                                            <c:when test="${emp.enabled == true}">
                                                <a class="btn btn-danger btn-xs ban"
                                                   title="禁用"
                                                   onclick="showConfirm('确定要禁用用户 ${emp.name} 么？','/employee/disable/${emp.empId}')">
                                                    <i class="fa fa-ban"></i>
                                                </a>
                                            </c:when>
                                            <c:otherwise>
                                                <a class="btn btn-success  btn-xs ok"
                                                   title="启用"
                                                   onclick="showConfirm('确定要启用用户 ${emp.name} 么？','/employee/enable/${emp.empId}')">
    ...
    <form id="employeeForm" class="form-horizontal" action="/employee/create" method="POST">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="control-label col-lg-4" for="mobile">员工手机号:</label>
                    <div class="controls col-lg-8">
